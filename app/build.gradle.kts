...
//    implementation("com.google.accompanist:accompanist-systemuicontroller:0.32.0")
    ...
    // Gson Converter (or Moshi, or Kotlinx Serialization)
    implementation("com.squareup.retrofit2:converter-gson:2.9.0") // Or converter-moshi / converter-kotlinx-serialization
    // OkHttp (Retrofit uses OkHttp internally) - Optional but good for logging interceptor
